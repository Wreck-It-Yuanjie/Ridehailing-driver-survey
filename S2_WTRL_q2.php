...
<!------------------------------------------------------------------------------------------->
<form method="post" action="S2_WTRL_q2add.php">
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.5em;">
  <div class="radio">
    ...
    <label><input required  <?php if($_SESSION["sp2modechoice0_worktime"]== "Yes") echo "Checked"; ?> type="radio" name="sp2modechoice0_worktime" value = "Yes" >&nbsp; Yes, keep working &nbsp;</label>
  </div>
</td>
<td  style="text-align: center; vertical-align: middle;font-size: 1.5em;">
  <div class="radio">
    <!-- <img class = "travelerday" src="img/pooled.png" width="260" height="200" /><br> -->
    <label><input required  <?php if($_SESSION["sp2modechoice0_worktime"]== "No") echo "Checked"; ?> type="radio" name="sp2modechoice0_worktime" value = "No" >&nbsp; No, stop working for now &nbsp;</label>
  </div>
</td>
</tr>
...
<?php 
  $modechoice0= $_POST['sp2modechoice0_worktime'];
?>
...
<center><a href="S2_WTRL_RL_q1prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
