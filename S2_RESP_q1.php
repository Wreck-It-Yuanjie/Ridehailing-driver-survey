...
$reponse2 = $bdd->prepare('select * from resp_levels where (person=:p)');

$reponse2->execute(array('p' => $_SESSION['userlvl'],)); ## assign "userlvl" to the variable p 

while($donnees = $reponse2->fetch()){
  if($donnees["sp"]==1){
  $_SESSION["sp1"] = $donnees;
}
  if($donnees["sp"]==2){
  $_SESSION["sp2"] = $donnees;
  ...
  if($donnees["sp"]==3){
  $_SESSION["sp3"] = $donnees;

  }

  if($donnees["sp"]==4){
  $_SESSION["sp4"] = $donnees;

  }

  if($donnees["sp"]==5){
  $_SESSION["sp5"] = $donnees;

  }

  if($donnees["sp"]==6){
  $_SESSION["sp6"] = $donnees;

  }
}

$_SESSION["donnees"]=$_SESSION["sp1"]; # defined senario 1
...
<!------------------------------------------------------------------------------------------->
<form method="post" action="S2_RESP_q1add.php">
     ...
     <div class="row">
       ...
       <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
          ...
          <div class="section">
            ...
            aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:56.4%">
              23/40
              </div>
            </center>
            </div>
...
<!-- Introduction -->
<center><h3> 13. Suppose you just recieved a trip request. The trip information is shown below. </h3></center>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp1modechoice0"]== "Accept") echo "Checked"; ?> type="radio" name="sp1modechoice0" value = "Accept" >&nbsp; Accept &nbsp;</h3>
  </div>
</td>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp1modechoice0"]== "Reject") echo "Checked"; ?> type="radio" name="sp1modechoice0" value = "Reject" >&nbsp; Reject &nbsp;</h3>
  </div>
</td>
</tr>
...
<center><a href="S3_q13prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
