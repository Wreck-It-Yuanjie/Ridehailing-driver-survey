...
$_SESSION["donnees"]=$_SESSION["sp6"]; # defined senario 1
...
<!------------------------------------------------------------------------------------------->
<form method="post" action="S2_RESP_q6add.php">
...
<center><h3> 18. Suppose you just recieved a trip request. The trip information is shown below. </h3></center>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp6modechoice0"]== "Accept") echo "Checked"; ?> type="radio" name="sp6modechoice0" value = "Accept" >&nbsp; Accept &nbsp;</h3>
  </div>
</td>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp6modechoice0"]== "Reject") echo "Checked"; ?> type="radio" name="sp6modechoice0" value = "Reject" >&nbsp; Reject &nbsp;</h3>
  </div>
</td>
</tr>
...
<center><a href="S2_RESP_q5prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
