...
$_SESSION["donnees"]=$_SESSION["sp5"]; # defined senario 1
...
<!------------------------------------------------------------------------------------------->
<form method="post" action="S2_RESP_q5add.php">
     ...
     <div class="row">
       ...
       <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
          ...
          <div class="section">
            ...
            aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:66.7%">
            27/40
              </div>
            </center>
            </div>
...
<center><h3> 17. Suppose you just recieved a trip request. The trip information is shown below. </h3></center>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp5modechoice0"]== "Accept") echo "Checked"; ?> type="radio" name="sp5modechoice0" value = "Accept" >&nbsp; Accept &nbsp;</h3>
  </div>
</td>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <h3><input required  <?php if($_SESSION["sp5modechoice0"]== "Reject") echo "Checked"; ?> type="radio" name="sp5modechoice0" value = "Reject" >&nbsp; Reject &nbsp;</h3>
  </div>
</td>
</tr>
...
<center><a href="S2_RESP_q4prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
