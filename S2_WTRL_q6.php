...
<!------------------------------------------------------------------------------------------->
<form method="post" action="S2_WTRL_q6add.php">
     ...
     <div class="row">
       ...
       <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12">
          ...
          <div class="section">
            ...
            aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:97.4%">
              39/40
              </div>
            </center>
            </div>
...
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    ...
    <label><input required  <?php if($_SESSION["sp6modechoice0_worktime"]== "Yes") echo "Checked"; ?> type="radio" name="sp6modechoice0_worktime" value = "Yes" >&nbsp; Yes, keep working &nbsp;</label>
  </div>
</td>
<td  style="text-align: center; vertical-align: middle;font-size: 1.3em;">
  <div class="radio">
    <!-- <img class = "travelerday" src="img/pooled.png" width="260" height="200" /><br> -->
    <label><input required  <?php if($_SESSION["sp6modechoice0_worktime"]== "No") echo "Checked"; ?> type="radio" name="sp6modechoice0_worktime" value = "No" >&nbsp; No, stop working for now &nbsp;</label>
  </div>
</td>
</tr>
...
<center><a href="S2_WTRL_RL_q5prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
