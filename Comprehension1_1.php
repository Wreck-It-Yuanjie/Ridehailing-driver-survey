...
<form method="post" action="Comprehension1_1add.php">
...
<center><h3>Please go back and review the concepts. You have one more chance to answer the question. </h3></center>
...
<tr>
  <div class="radio" style="text-align: center; vertical-align: middle;font-size: 1.5em;">
    ...
    <label><input required  <?php if($_SESSION["comp1"]== "Yes") echo "Checked"; ?> type="radio" name="comp1" value = "Yes" >&nbsp; I expect to wait 8 minutes for my next trip if I go to neighborhood N2 &nbsp;</label>
  </div>

    <div class="radio" style="text-align: center; vertical-align: middle;font-size: 1.5em;">
    <!-- <img class = "travelerday" src="img/pooled.png" width="260" height="200" /><br> -->
    <label><input required  <?php if($_SESSION["comp1"]== "No_1") echo "Checked"; ?> type="radio" name="comp1" value = "No_1" >&nbsp; It takes 8 minutes to travel from where I am to neighborhood N2 &nbsp;</label>
  </div>
  <div class="radio" style="text-align: center; vertical-align: middle;font-size: 1.5em;">
    <!-- <img class = "travelerday" src="img/pooled.png" width="260" height="200" /><br> -->
    <label><input required  <?php if($_SESSION["comp1"]== "No_2") echo "Checked"; ?> type="radio" name="comp1" value = "No_2" >&nbsp; I earn extra $8 in neighborhood N2 &nbsp;</label>
  </div>

  <div class="radio" style="text-align: center; vertical-align: middle;font-size: 1.5em;">
    <!-- <img class = "travelerday" src="img/pooled.png" width="260" height="200" /><br> -->
    <label><input required  <?php if($_SESSION["comp1"]== "No_3") echo "Checked"; ?> type="radio" name="comp1" value = "No_3" >&nbsp; It takes 8 minutes to pick up the passenger &nbsp;</label>
  </div>
</tr>
...
<tr>
  ...
  <td style="width: 18%; text-align: right; vertical-align: middle; font-size: 1.3em; border: none;"><br>Surge price: <br>Waiting time: <br>Travel time: </td>
  <td onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" id="n12" onclick="func2()" style="width: 18%; text-align: center; vertical-align: middle;font-size: 1.3em;">&nbsp; <b>N2</b> <br> $0  <span style = "color:red"><b><br> 8 min <br></b></span> 12 min</td>
...
<center><a href="Experimentguide1prev.php"><button type="button"><h2>Previous</h2></button></a></center>
</div>
